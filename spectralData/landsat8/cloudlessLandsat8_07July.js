...
// Filter the image collection by intersection with the area of interest from 2013 to 2018 for the month of July.
var landsatFiltered = landsat8TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2013, 2018, 'year')).filter(ee.Filter.calendarRange(7, 7, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Land8_07July_1_ultraBlue',
  scale: 30,
...
Export.image.toDrive({
  image: band_2_blue,
  description: 'Land8_07July_2_blue',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: band_3_green,
  description: 'Land8_07July_3_green',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: band_4_red,
  description: 'Land8_07July_4_red',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_07July_5_nearInfrared',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_07July_6_shortInfrared1',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_07July_7_shortInfrared2',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
