...
// Filter the image collection by intersection with the area of interest from 2013 to 2018 for the month of October.
var landsatFiltered = landsat8TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2013, 2018, 'year')).filter(ee.Filter.calendarRange(10, 10, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Land8_10October_1_ultraBlue',
  scale: 30,
...
Export.image.toDrive({
  image: band_2_blue,
  description: 'Land8_10October_2_blue',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: band_3_green,
  description: 'Land8_10October_3_green',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: band_4_red,
  description: 'Land8_10October_4_red',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_10October_5_nearInfrared',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_10October_6_shortInfrared1',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_10October_7_shortInfrared2',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: evi2,
  description: 'Land8_10October_evi2',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: nbr,
  description: 'Land8_10October_nbr',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndmi,
  description: 'Land8_10October_ndmi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndsi,
  description: 'Land8_10October_ndsi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndvi,
  description: 'Land8_10October_ndvi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndwi,
  description: 'Land8_10October_ndwi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});