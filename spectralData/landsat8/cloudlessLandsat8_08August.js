...
// Filter the image collection by intersection with the area of interest from 2013 to 2018 for the month of August.
var landsatFiltered = landsat8TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2013, 2018, 'year')).filter(ee.Filter.calendarRange(8, 8, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Land8_08August_1_ultraBlue',
  scale: 30,
...
Export.image.toDrive({
  image: band_2_blue,
  description: 'Land8_08August_2_blue',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: band_3_green,
  description: 'Land8_08August_3_green',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: band_4_red,
  description: 'Land8_08August_4_red',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_08August_5_nearInfrared',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_08August_6_shortInfrared1',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_08August_7_shortInfrared2',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: evi2,
  description: 'Land8_08August_evi2',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: nbr,
  description: 'Land8_08August_nbr',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndmi,
  description: 'Land8_08August_ndmi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndsi,
  description: 'Land8_08August_ndsi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndvi,
  description: 'Land8_08August_ndvi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: ndwi,
  description: 'Land8_08August_ndwi',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});