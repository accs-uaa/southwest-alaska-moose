...
var landsatFiltered = landsat8TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2013, 2018, 'year')).filter(ee.Filter.calendarRange(5, 5, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Land8_05May_1_ultraBlue',
  scale: 30,
...
Export.image.toDrive({
  image: band_2_blue,
  description: 'Land8_05May_2_blue',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  image: band_3_green,
  description: 'Land8_05May_3_green',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
...
Export.image.toDrive({
  ...
  description: 'Land8_05May_5_nearInfrared',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_05May_6_shortInfrared1',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
Export.image.toDrive({
  ...
  description: 'Land8_05May_7_shortInfrared2',
  scale: 30,
  region: areaOfInterest,
  maxPixels: 30000000000
});
