/* -*- coding: utf-8 -*-
---------------------------------------------------------------------------
Cloud-reduced Greenest Pixel Composite Sentinel 2 Imagery for July 2015-2018
...
// Filter the image collection by intersection with the area of interest from 2015 to 2018 for the month of July.
var sentinelFiltered = sentinel2TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2015, 2018, 'year')).filter(ee.Filter.calendarRange(7, 7, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Sent2_07July_1_ultraBlue',
  scale: 60,
