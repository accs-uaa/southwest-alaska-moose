/* -*- coding: utf-8 -*-
---------------------------------------------------------------------------
Cloud-reduced Greenest Pixel Composite Sentinel 2 Imagery for September 2015-2018
...
// Filter the image collection by intersection with the area of interest from 2015 to 2018 for the month of September.
var sentinelFiltered = sentinel2TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2015, 2018, 'year')).filter(ee.Filter.calendarRange(9, 9, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Sent2_09September_1_ultraBlue',
  scale: 60,
