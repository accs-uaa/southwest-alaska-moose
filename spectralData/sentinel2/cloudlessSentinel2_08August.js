/* -*- coding: utf-8 -*-
---------------------------------------------------------------------------
Cloud-reduced Greenest Pixel Composite Sentinel 2 Imagery for August 2015-2018
...
// Filter the image collection by intersection with the area of interest from 2015 to 2018 for the month of August.
var sentinelFiltered = sentinel2TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2015, 2018, 'year')).filter(ee.Filter.calendarRange(8, 8, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Sent2_08August_1_ultraBlue',
  scale: 60,
