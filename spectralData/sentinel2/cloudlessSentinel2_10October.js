/* -*- coding: utf-8 -*-
---------------------------------------------------------------------------
Cloud-reduced Greenest Pixel Composite Sentinel 2 Imagery for October 2015-2018
...
// Filter the image collection by intersection with the area of interest from 2015 to 2018 for the month of October.
var sentinelFiltered = sentinel2TOA.filterBounds(areaOfInterest).filter(ee.Filter.calendarRange(2015, 2018, 'year')).filter(ee.Filter.calendarRange(10, 10, 'month'));
...
Export.image.toDrive({
  ...
  description: 'Sent2_10October_1_ultraBlue',
  scale: 60,
