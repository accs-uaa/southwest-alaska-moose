...
elevation_C6 = os.path.join(drive,
                            root_folder,
                            'Data/topography/Composite_10m_Beringia/gridded_full/Grid_C6/Elevation_Composite_10m_Beringia_AKALB_Grid_C6.tif')
elevation_D5 = os.path.join(drive,
                            root_folder,
                            'Data/topography/Composite_10m_Beringia/gridded_full/Grid_D5/Elevation_Composite_10m_Beringia_AKALB_Grid_D5.tif')
elevation_D6 = os.path.join(drive,
                            root_folder,
                            'Data/topography/Composite_10m_Beringia/gridded_full/Grid_D6/Elevation_Composite_10m_Beringia_AKALB_Grid_D6.tif')

# Define output raster
elevation_covariate = os.path.join(data_folder, 'Data_Input/topography/elevation.tif')

# Define input and output arrays
combine_inputs = [study_area, elevation_C6, elevation_D5, elevation_D6]
