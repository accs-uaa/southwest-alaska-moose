...
roughness_C6 = os.path.join(drive,
                            root_folder,
                            'Data/topography/Composite_10m_Beringia/gridded_full/Grid_C6/Roughness_Composite_10m_Beringia_AKALB_Grid_C6.tif')
roughness_D5 = os.path.join(drive,
                            root_folder,
                            'Data/topography/Composite_10m_Beringia/gridded_full/Grid_D5/Roughness_Composite_10m_Beringia_AKALB_Grid_D5.tif')
roughness_D6 = os.path.join(drive,
                            root_folder,
                            'Data/topography/Composite_10m_Beringia/gridded_full/Grid_D6/Roughness_Composite_10m_Beringia_AKALB_Grid_D6.tif')

# Define output raster
roughness_covariate = os.path.join(data_folder, 'Data_Input/topography/roughness.tif')

# Define input and output arrays
combine_inputs = [study_area, roughness_C6, roughness_D5, roughness_D6]
